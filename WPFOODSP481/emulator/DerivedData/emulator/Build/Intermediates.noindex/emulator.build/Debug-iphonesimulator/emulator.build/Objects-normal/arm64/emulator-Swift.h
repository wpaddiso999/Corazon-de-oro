...
#ifndef EMULATOR_SWIFT_H
#define EMULATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="emulator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8emulator11AppDelegate")
...
SWIFT_CLASS("_TtC8emulator13SceneDelegate")
...
SWIFT_CLASS("_TtC8emulator14ViewController")
